export default function Field(id, type, label, size = 1) {
  ...
  if (size > 1) {
    ...
    container.innerHTML = `
        <input
            class="w-full py-1 pl-1 pr-8 rounded bg-white border border-gray-500 mb-6 focus-visible:outline-0 focus-visible:border-sky-500 focus-visible:placeholder:invisible peer"
